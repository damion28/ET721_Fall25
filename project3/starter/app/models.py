...
class FruitMetrics:
    ...
    @staticmethod
    def remove_fruit_by_name(fruits, name):
        """
        Remove a fruit from the list by name.
        Returns a new list without the removed fruit.
        """
        return [fruit for fruit in fruits if fruit.name != name]